<div class="card">
    <div class="card-head" style="position:relative">
       <h5 class="card-header" style="font-weight:900">Recibo de Vencimento</h5>
       <a href="{{route('salarioPdf',array($fun->id,$mm->mes))}}" style="text-decoration:none; color:black;position-absolute; display:block;float:right; padding-right:30px;margin-top:-33px">Abrir em<span style="margin-left:3px;" class="badge badge-warning">PDF</span></a>
    </div>
    <div class="card-body">
        <div class="container">
            <hr>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <p><span style="font-weight: 900; ">Empresa:</span></p>
                    <p><span style="font-weight: 900; ">Data fecho:</span> {{date('d/m/y', strtotime($mm->created_at))}}</p>
                    <p><span style="font-weight: 900; ">Cod. Recibo: </span></p><span></span>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <p><span style="font-weight: 900; ">Categória:</span></p>
